...
/// @brief Set the time step size for the job
/// @note You have to call this function before the ros2 executor
/// @note is runnning. So you cannot call this in a timer or subscription
...
bool get_finished();
/// @brief Get the time step size for the job
/// @note This is used internally to get the time step size for the job
rclcpp::Duration get_time_step_size();
}  // namespace internal
}  // namespace rslcpp::dynamic_job
